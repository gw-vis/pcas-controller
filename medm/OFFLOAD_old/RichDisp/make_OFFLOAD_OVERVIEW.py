...
TYPEA,ITMY,IP,GAS,
    ...
    MOTOR:
        ...
        $(IFO):STEPPER-(SYSTEM)_GAS_(DRIVERCH)
...
TYPEB,SR3,IP,GAS,
    ...
    $(IFO):VIS-$(SYSTEM)_IP_xxx_L_OUTPUT, T_OUTPUT, Y_OUTPUT, 
    $(IFO):VIS-$(SYSTEM)_F0_COILOUTF_GAS_INMON, F1, F2, BF
    IFO : K1
...
TYPEBP,PR2,GAS,
TYPEBP,PR3,GAS,
    $(IFO):VIS-$(SYSTEM)_SF_COILOUTF_GAS_INMON, BF
    IFO : K1
    SYSTEM: PRM, PR2, PR3
    MOTOR:
...
if __name__=='__main__':
    ...
    model = {
        ...
        'ITMX': {'Type': 'TypeA', 'CELL':{ 'colum':0, 'line':1 }, 'BS':{ 'F0':'ETMX_GAS_0', 'F1':'ETMX_GAS_1', 'F2':'ETMX_GAS_2', 'F3':'ETMX_GAS_5', 'BF':'ETMX_GAS_4'}},
        'ETMY': {'Type': 'TypeA', 'CELL':{ 'colum':0, 'line':2 }, 'BS':{ 'F0':'ETMX_GAS_0', 'F1':'ETMX_GAS_1', 'F2':'ETMX_GAS_2', 'F3':'ETMX_GAS_5', 'BF':'ETMX_GAS_4'}},
        'ITMY': {'Type': 'TypeA', 'CELL':{ 'colum':0, 'line':3 }, 'BS':{ 'F0':'ETMX_GAS_0', 'F1':'ETMX_GAS_1', 'F2':'ETMX_GAS_2', 'F3':'ETMX_GAS_3', 'BF':'ETMX_GAS_4'}},

        'BS':  {'Type': 'TypeB', 'CELL':{ 'colum':1, 'line':0 }, 'BS':{ 'F0':'BS_GAS_3', 'F1':'BS_GAS_1', 'BF':'BS_GAS_0'}},
        'SR2': {'Type': 'TypeB', 'CELL':{ 'colum':1, 'line':1 }, 'BS':{ 'F0':'SR2_GAS_2', 'F1':'SR2_GAS_1', 'BF':'SR2_GAS_0'}},
        'SR3': {'Type': 'TypeB', 'CELL':{ 'colum':1, 'line':2 }, 'BS':{ 'F0':'SR3_GAS_2', 'F1':'SR3_GAS_1', 'BF':'SR3_GAS_0'}},
        'SRM': {'Type': 'TypeB', 'CELL':{ 'colum':1, 'line':3 }, 'BS':{ 'F0':'SRM_GAS_3', 'F1':'SRM_GAS_1', 'BF':'SRM_GAS_0'}},

        'PR2': {'Type': 'TypeBp', 'CELL':{ 'colum':2, 'line':0 }, 'BS':{ 'BF':'PR2_GAS_1', 'SF':'PR2_GAS_2'}},
        'PR3': {'Type': 'TypeBp', 'CELL':{ 'colum':2, 'line':1 }, 'BS':{ 'BF':'PRO_GAS_0', 'SF':'PRO_GAS_1'}},   # Motor !
        'PRM': {'Type': 'TypeBp', 'CELL':{ 'colum':2, 'line':2 }, 'BS':{ 'BF':'PR0_GAS_2', 'SF':'PR0_GAS_3'}}
    }
